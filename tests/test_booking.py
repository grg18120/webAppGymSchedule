...
class BookingRolesTest(unittest.TestCase):
    ...
    def test_timeline_is_available_to_every_role(self):
        ...
        self.assertIn(b"Your booking", casey_page.data)
        self.assertIn(b'data-slot-state', casey_page.data)
        self.assertIn(b">Open<", casey_page.data)
        self.assertIn(b'timeline__block--booked', casey_page.data)
        self.assertIn(b'timeline__block--available', casey_page.data)
        self.assertNotIn(b"timeline__block--full", casey_page.data)
        self.assertIn(b"timeline-swatch--full", casey_page.data)
        self.assertIn(b"Red slots are full", casey_page.data)
        self.assertNotIn(b"timeline__block--partial", casey_page.data)
        self.assertNotIn(b"--booked-pct:", casey_page.data)
        self.assertNotIn(b"Open &amp; Booked", casey_page.data)
        self.assertNotIn(b"timeline-swatch--partial", casey_page.data)
        self.assertNotIn(b"Positions:", casey_page.data)
        self.assertNotIn(b"timeline__block-positions", casey_page.data)
        ...
        self.assertIn(b"timeline__block--booked", jordan_page.data)
        self.assertIn(b"timeline__block--full", jordan_page.data)
        self.assertIn(b"Your booking", jordan_page.data)
        self.assertIn(b"data-slot-state>Full", jordan_page.data)
        self.assertNotIn(b"timeline__block--partial", jordan_page.data)
        self.assertNotIn(b"Open &amp; Booked", jordan_page.data)
        self.assertNotIn(b"Positions:", jordan_page.data)
        ...
        riley_page = self.client.get("/timeline?start=2099-06-16")
        ...
        self.assertIn(book_path, riley_page.data)
        self.assertNotIn(cancel_path, riley_page.data)
        ...
        self.assertIn(b".timeline__block-state", css)
    ...
    def test_client_can_register_interest_on_a_full_timeline_slot(self):
        ...
        self.assertNotIn(b"timeline__block--booked", page.data)
        ...
        self.assertIn(b"Your interest", page.data)
        self.assertIn(b"timeline-swatch--interest", page.data)
        ...
        self.assertIn(b"data-slot-state>Interested", marked.data)
        self.assertIn(b"You asked for a place", marked.data)
        ...
        self.assertIn(b"data-slot-state>Full", withdrawn.data)
        ...
        self.assertIn(b".timeline__interest-remove", css)
        self.assertIn(b".timeline__interest-panel-copy", css)
        ...
        self.assertIn(b'state.textContent = "Interested"', js)

    def test_adding_a_client_clears_their_session_interest(self):
        from datetime import datetime, timedelta
        ...
        ok, message = booking.add_interest(session, riley)
        self.assertTrue(ok, message)
        self.assertTrue(session.is_interested_by(riley))
        ...
        ok, message, fields = booking.update_session_slot(
            ...
            2,
            client_ids=[casey.id, riley.id],
        )
        self.assertTrue(ok, message)
        self.assertEqual(fields, [])
        refreshed = db.session.get(GymSession, session.id)
        self.assertTrue(refreshed.is_booked_by(riley))
        self.assertTrue(refreshed.is_booked_by(casey))
        self.assertFalse(refreshed.is_interested_by(riley))
        self.assertEqual(
            GymSessionInterest.query.filter_by(
                session_id=session.id, client_id=riley.id
            ).count(),
            0,
        )
        ...
        page = self.client.get("/timeline?start=2099-08-17")
        self.assertEqual(page.status_code, 200)
        self.assertIn(b"data-slot-state>Your booking", page.data)
        self.assertNotIn(b"data-slot-state>Interested", page.data)
        self.assertNotIn(b"timeline__interest-flag", page.data)
    ...
    def test_home_shows_stats_for_each_role(self):
        ...
        self.assertGreaterEqual(current_row["client_past_hours"], 2.0)
        ...
        self.assertEqual(instructor_dash["client_chart"]["kind"], "client")
        ...
        client_current_group = next(
            group
            for group in instructor_dash["client_chart"]["groups"]
            if current_month in group["summary"]
        )
        self.assertEqual(len(client_current_group["bars"]), 2)
        self.assertIn("past client hours", client_current_group["bars"][0]["title"])
        self.assertEqual(client_current_group["bars"][0]["fill"], "#1565c0")
        self.assertIn("upcoming client hours", client_current_group["bars"][1]["title"])
        self.assertEqual(client_current_group["bars"][1]["fill"], "#90caf9")
        ...
        self.assertIn("Next session", labels)
        self.assertNotIn("Unbooked this month", labels)
        self.assertNotIn("Fill rate this month", labels)
        self.assertNotIn("Clients this month", labels)
        self.assertNotIn("Upcoming booked sessions", labels)
        ...
        self.assertNotIn(b"Unbooked this month", instructor_home.data)
        self.assertNotIn(b"Fill rate this month", instructor_home.data)
        self.assertNotIn(b"Clients this month", instructor_home.data)
        ...
        self.assertIn(b"Sessions this month", client_home.data)
        self.assertNotIn(b"Average unbooked / month", client_home.data)
        self.assertNotIn(b"Hours in the last 6 months", client_home.data)
        ...
        self.assertIn("past client hours", client_group["bars"][0]["title"])
        self.assertEqual(client_group["bars"][0]["fill"], "#1565c0")
        self.assertIn("upcoming client hours", client_group["bars"][1]["title"])
        ...
        self.assertIn(b".stat-chart + .stat-chart", css)
